...
class AlignSubNet(nn.Module):
    def __init__(self, args, mode):
        ...
        in_dim_t, in_dim_a= args.feature_dim
        seq_len_t, seq_len_a = args.input_len
        self.dst_len = min(seq_len_t, seq_len_a)
        self.mode = mode
    ...
    def __avg_pool(self, text_x, audio_x):
        def align(x):
    ...
    def __conv1d(self, text_x, audio_x):
    ...
    def forward(self, text_x, audio_x):
        return self.ALIGN_WAY[self.mode](text_x, audio_x)