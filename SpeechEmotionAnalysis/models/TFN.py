...
class TFN(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.audio_subnet = SubNet(self.audio_in, self.audio_hidden, self.audio_prob)#16
        self.text_subnet = TextSubNet(self.text_in, self.text_hidden, self.text_out, dropout=self.text_prob)#128
    ...
    def forward(self, text_x, audio_x):
        ...
        fusion_tensor = fusion_tensor.view(-1, (self.audio_hidden + 1) * (self.text_out + 1))
